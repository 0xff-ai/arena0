...
pub mod prelude {
    pub use crate::{
        ...
        EnsembleError, Event, HashAlgorithm, IntoTimerEffect, LocalContext, LocalDebug, LocalState,
        LogLevel, MessageApply, Open, Participant, ParticipantCount, PeerId, PhasedSharedState,
        Primitive, PrimitiveField, PrimitiveOutput, PrimitiveOutputs, PrimitiveRoute,
        ...
        RawPrimitiveRoute, SharedState, SignScheme, Signed, StateHash, StateSchema, TimerPayload,
        TimerSchedule, TimerSpec, TraceEntry, Transition, View, Viewport, timer_payload,
    };
