...
| Portable/light receipt verification | `arena0-verify` |
...
The daemon and CLI use the same portable/light verifier from `arena0-verify`.
Verification checks receipt bytes and protocol signatures without loading the
Wasm sandbox.
